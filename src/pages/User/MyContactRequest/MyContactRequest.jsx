      ...
      <table className="min-w-full bg-white">
        ...
        { requestData?.map((request) => 
            <tr key={request?._id}>
              ...
              <td className="px-4 py-3 text-sm text-slate-600 font-medium">{request?.status ? request?.partnerEmail : "*****@***.com"}</td>
              <td className="px-4 py-3 text-sm text-slate-600 font-medium">{request?.status ? request?.partnerNumber : "**********"}</td>
