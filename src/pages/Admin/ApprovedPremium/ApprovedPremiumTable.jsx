...
const ApprovedPremiumTable = ({premium,handleMakePremium,handlePremiumInfoDelete}) => {
    const {_id, name, biodata_id,contact_email } = premium;
    const [bio] = useBio();
  return (
    <tr>
      ...
      <td onClick={() => handlePremiumInfoDelete(_id,name)} className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
