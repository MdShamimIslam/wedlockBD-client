...
const Nodata = () => {
  return (
    <div className="flex justify-center items-center my-44 text-center">
      <div className="w-2/3">
        <h2 className="text-3xl font-bold mb-3 text-purple-500">----Keep In Mind----</h2>
        <p>
          Before making a request for contact information, you must create your
          own profile, so click the button below to create your bio, then send a
          request for contact information to the person of your choice.
        </p>
        <Link to="/add-biodata">
